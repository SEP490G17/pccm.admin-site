        ...
        <>
            ...
            >
                <Flex flexWrap={'wrap'} gap={'1rem'}>
                    ...
                    <Select
                        ...
                        defaultValue={{
                            ...
                            label:
                                logOption.find(option => option.value === productLogPageParams.LogType)?.label ?? 'Tất cả',
                        }}
                        className="w-56 rounded border-[1px solid #ADADAD] shadow-none hover:border-[1px solid #ADADAD]"
                        onChange={async (e) => {
                            if (e) {
                ...
                <Flex textAlign="right" flexWrap={'wrap'} gap={'1rem'}>
                    <DatePicker.RangePicker
                        ...
                        defaultValue={
                            productLogPageParams.fromDate && productLogPageParams.toDate
                                ? [dayjs(productLogPageParams.fromDate, 'DD/MM/YYYY'), dayjs(productLogPageParams.fromDate, 'DD/MM/YYYY')]
                                : undefined
                        }
                        onChange={(value) => {
                    ...
                    />
                    <InputSearchBoxAtoms value={productLogPageParams.searchTerm} handleChange={onSearchChangeProductLog} isPending={isPending} />
                </Flex>
            </Flex>
            <Flex
                width="100%"
