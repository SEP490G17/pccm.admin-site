                ...
                {(props) => (
                  <Form>
                    <FormControl isRequired>
                      <FormLabel className="title_label">Tên hàng hóa</FormLabel>
                      <Input className="input_text" type="text" name="name" placeholder="Nhập" />
                    </FormControl>
                    <HStack>
                      <FormControl>
                      ...
                      <FormControl>
                        <FormLabel className="title_label">Số lượng</FormLabel>
                        <Input
                          name="quantity"
                          placeholder="xxxxxxx"
                      ...
                      <FormControl>
                        <FormLabel className="title_label">Giá cả</FormLabel>
                        <Input
                          name="price"
                          placeholder="xxxxxxx"
                          className="input_text"
                    ...
                    <FormControl>
                      <FormLabel className="title_label">Ảnh sản phẩm</FormLabel>
                      <FileUpload></FileUpload>
                    </FormControl>

                    <FormControl>
                      <FormLabel className="title_label">Mô tả hàng hóa</FormLabel>
                      <Input
                        name="description"
