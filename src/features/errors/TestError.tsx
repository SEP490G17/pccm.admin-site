    ...
    <>
      ...
      <Box p={4} borderWidth={1} borderRadius="md" boxShadow="sm">
        <ButtonGroup spacing={3} width="100%">
          ...
          <Button onClick={handleBadRequest} colorScheme="blue" variant="outline">
            Bad Request
          </Button>
          <Button onClick={handleValidationError} colorScheme="blue" variant="outline">
            Validation Error
          </Button>
          <Button onClick={handleServerError} colorScheme="blue" variant="outline">
            Server Error
          </Button>
          <Button onClick={handleUnauthorised} colorScheme="blue" variant="outline">
            Unauthorised
          </Button>
